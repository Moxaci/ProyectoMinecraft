<?php
// api/agregar_item.php
// Agrega un item al proyecto
...
$cantidad = intval($_POST['cantidad'] ?? 64);

if ($proyectoId <= 0 || empty($itemId) || $cantidad <= 0) {
...
$success = upsertProyectoItem($conn, $proyectoId, $itemId, $cantidad);
closeConnection($conn);
...
if ($success) {
    ...
    sendErrorResponse('Error al agregar el item', 500);
}
?>