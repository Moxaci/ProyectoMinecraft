# CraftLog — Calculadora Logística
...
* **Características principales:**
  * **Motor de cálculo automático:** Desglosa automáticamente las recetas de crafteo hasta el nivel de material base.
...
Este proyecto cuenta con una arquitectura web ágil y eficiente:

* **Frontend:** HTML5, CSS3 (con sistema de diseño inspirado en estética pixel-art).
* **Lógica y Procesamiento:** JavaScript (encargado del algoritmo de descomposición recursiva y el control del flujo de datos).
* **Base de datos:** MySQL (gestión de persistencia de proyectos, ítems y usuarios).
* **Administración de Datos:** phpMyAdmin (entorno utilizado para el diseño, control y mantenimiento del modelo relacional).
